...
// Las optimizaciones del compilador pueden hacer que optimice la localizaci�n de estas variables dentro del mapa de memoria. 
// Para que en ambos procesadores est�n en la misma regi�n, se estable la m�nima optimizaci�n (o0) en esta parte del programa en ambos cores.
