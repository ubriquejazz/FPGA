...
#define BUFSIZE 64
#define CTL_REG0   *(ms3_ptr + CTL0_ADDR)
#define CTL_REG1   *(ms3_ptr + CTL1_ADDR)

#define UART1_RBR  *(ms3_ptr + UART1_OFFSET + RBR_ADDR)
#define UART1_THR  *(ms3_ptr + UART1_OFFSET + THR_ADDR)
#define UART1_DLL  *(ms3_ptr + UART1_OFFSET + DLL_ADDR)
#define UART1_DLM  *(ms3_ptr + UART1_OFFSET + DLM_ADDR)
#define UART1_IER  *(ms3_ptr + UART1_OFFSET + IER_ADDR)
#define UART1_IIR  *(ms3_ptr + UART1_OFFSET + IIR_ADDR)
#define UART1_FCR  *(ms3_ptr + UART1_OFFSET + FCR_ADDR)
#define UART1_LCR  *(ms3_ptr + UART1_OFFSET + LCR_ADDR)
#define UART1_MCR  *(ms3_ptr + UART1_OFFSET + MCR_ADDR)
#define UART1_LSR  *(ms3_ptr + UART1_OFFSET + LSR_ADDR)
#define UART1_MSR  *(ms3_ptr + UART1_OFFSET + MSR_ADDR)
#define UART1_SCR  *(ms3_ptr + UART1_OFFSET + SCR_ADDR)

#define UART2_RBR  *(ms3_ptr + UART2_OFFSET + RBR_ADDR)
#define UART2_THR  *(ms3_ptr + UART2_OFFSET + THR_ADDR)
#define UART2_DLL  *(ms3_ptr + UART2_OFFSET + DLL_ADDR)
#define UART2_DLM  *(ms3_ptr + UART2_OFFSET + DLM_ADDR)
#define UART2_IER  *(ms3_ptr + UART2_OFFSET + IER_ADDR)
#define UART2_IIR  *(ms3_ptr + UART2_OFFSET + IIR_ADDR)
#define UART2_FCR  *(ms3_ptr + UART2_OFFSET + FCR_ADDR)
#define UART2_LCR  *(ms3_ptr + UART2_OFFSET + LCR_ADDR)
#define UART2_MCR  *(ms3_ptr + UART2_OFFSET + MCR_ADDR)
#define UART2_LSR  *(ms3_ptr + UART2_OFFSET + LSR_ADDR)
#define UART2_MSR  *(ms3_ptr + UART2_OFFSET + MSR_ADDR)
#define UART2_SCR  *(ms3_ptr + UART2_OFFSET + SCR_ADDR)
