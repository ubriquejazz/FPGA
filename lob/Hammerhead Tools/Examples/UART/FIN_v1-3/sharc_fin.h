...
*  -------------------------                                                  *
*  sharc_fin.h : Support for the SHARC FIN ASIC                               *
*                                                                             *
*  PROVIDED BY:                                                               *
*  ------------                                                               *
...
#define HH1_IRQ0      0x50  //HH1_IRQ0 int mux register
#define HH2_IRQ0      0x52  //HH2_IRQ0 int mux register
#define HH3_IRQ0      0x54  //HH3_IRQ0 int mux register
#define HH4_IRQ0      0x56  //HH4_IRQ0 int mux register
#define HH_PCINT      0x58	//PCInt
#define RESERVED4     0x59	//Unused
#define HH_PMCI0      0x5A	//PMCI0 int mux register
#define HH_PMCI1      0x5B	//PMCI1 int mux register
