...
Notes:
1.  The files FIN_PCI_HH.DLB and UTIL_LIB.DLB are needed for this example.  
...
2.  The PCI library source files are fin_pci.c and fin_pci.h, located in d:\<yourpath>\examples\libs\PCI.  Refer to these files for details and usage 
information.

3.  The Utility library source files are utils.c and utils.h, located in d:\<yourpath>\examples\libs\UTILS.  Refer to these files for details and usage 
information.
...
6.  If you have SharcFIN version 4 or above, you may use the Clusterbus DMA 
