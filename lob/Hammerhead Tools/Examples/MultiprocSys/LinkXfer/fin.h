...
// Bittware-specific control registers
...
#define FIN_PMCA_CFG_REG  0x44	//PMCA Config Register	
#define FIN_PMCB_STAT_REG 0x45	//PMCB Status Register (unimplemented)	
#define FIN_OB_I2C_CTL    0x46	//Onboard I2C Control Register	
#define FIN_PMC_I2C_CTL   0x47	//PMC I2C Control Register	
#define FIN_SD_SIZE_CFG   0x48	//SD Size Config Register	
#define FIN_SD_CONFIG_WD  0x49	//SD Config Word Register	
#define FIN_SD_WINDOW_REG 0x4A	//SD Window Register	
#define FIN_MAX3100       0x4B	//MAX3100 Uart Reg
#define FIN_RESERVED0     0x4C	//Unused
#define FIN_RESERVED1     0x4D	//Unused
#define FIN_RESERVED2     0x4E	//Unused
#define FIN_RESERVED3     0x4F	//Unused
// INT MUX Regs
#define FIN_HH1_IRQ0      0x50  //HH1_IRQ0 map to flags
#define FIN_HH1_IRQ1      0x51  //HH1_IRQ1 map to flags
#define FIN_HH2_IRQ0      0x52  //HH2_IRQ0 map to flags
#define FIN_HH2_IRQ1      0x53  //HH2_IRQ1 map to flags
#define FIN_HH3_IRQ0      0x54  //HH3_IRQ0 map to flags
#define FIN_HH3_IRQ1      0x55  //HH3_IRQ1 map to flags
#define FIN_HH4_IRQ0      0x56  //HH4_IRQ0 map to flags
#define FIN_HH4_IRQ1      0x57  //HH4_IRQ1 map to flags
#define FIN_HH_PCINT      0x58	//PCInt
#define FIN_RESERVED4     0x59	//Unused
#define FIN_HH_PMCI0      0x5A	//PMCI0
#define FIN_HH_PMCI1      0x5B	//PMCI1

// INT MUX Bit definitions
#define B_H1F0_MSK        0x0001 // Hammerhead 1, flag0
#define B_H1F1_MSK        0x0002 // Hammerhead 1, flag1
#define B_H2F0_MSK        0x0004 // Hammerhead 2, flag0
#define B_H2F1_MSK        0x0008 // Hammerhead 2, flag1
#define B_H3F0_MSK        0x0010 // Hammerhead 3, flag0
#define B_H3F1_MSK        0x0020 // Hammerhead 3, flag1
#define B_H4F0_MSK        0x0040 // Hammerhead 4, flag0
#define B_H4F1_MSK        0x0080 // Hammerhead 4, flag1
#define B_PCFLG_MSK       0x0100 // PCI sourced flag
#define B_PMCFLG0_MSK     0x0200 // PMC+ Flag0
#define B_PMCFLG1_MSK     0x0400 // PMC+ Flag1
#define B_PRFLG_MSK       0x0800 //
#define B_UART0_MSK       0x1000 // UART0 flag
#define B_UART1_MSK       0x2000 // UART1 flag

#define FIN_RESERVED5     0x5C	 //Unused
#define FIN_RESERVED6     0x5D	 //Unused
#define FIN_HH_FLAGS      0x5E	 //Flgs
