...
#define LINE_SIZE		1024					// pixel per line (32-bits words) 
#define N				1024					// pixel per line (32-bits words) 
...
{
	int i,j, k;
	U32 image[TOTAL_PIXELS];				// data input  (128KB < 64MB)
	U32 fft[TOTAL_PIXELS];					// data output (128KB < 64MB)
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	for (i = 0; i < Num_Frames; i++ )
	{
		...
		dsp21k_dl_32s( processor1, dsp_addr1, Total_Pixels, pin );
	...
	for (k=0; k<Frame_Size; k++)
	{
		...
		for (i=0; i<4; i++)
		{
			...
			{
				printf("%x ", fft[ (k*LINE_SIZE ) + i*(LINE_SIZE/4) + j]);
			}
			printf("\n");
		}
	}
