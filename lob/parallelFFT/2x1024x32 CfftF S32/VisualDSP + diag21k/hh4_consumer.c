...
//  This code is designed to run on processor 4.
//
//***********************************************************************
...
#define LINE_SIZE            2*1024                // line data = 1024 8-byte pixels (complex_float pixels)
...
int fft_data[2][LINE_PKT];			// 4-deep output data buffer
int rcvd_P1[2][LINE_PKT];         	// 4-deep rx data buffer

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Functions Definitions
/////////////////////////////////////////////////////////////////////////////////////////////////////////

void link2_handler(int signum)
{
		rx_data = 1;
}
...
void Processing(int txbuf)
{
	...
	for (i=0, j=0; i<FFT_SIZE; i+=2)
		{
		input_r[i] =(float)rcvd_P1[txbuf][j++];
		input_i[i]  =(float)rcvd_P1[txbuf][j++];
...
/////////////////////////////////////////////////////////
	...
	// interrupt each time link 2 completes
	interrupt(SIG_LP2I, link2_handler);
...
/////////////////////////////////////////////////////////
	do
	{
		...
		for (i=0; i<LINE_PKT; i++)
			fft_data[txbuf][i] = 0; //rcvd_P1[txbuf][i];
		Processing(txbuf);		
		...
		// Send 1/4 raw data to HH_PROC1 by the Link3
		LinkTX_P1(txbuf);
		txpkts++;
